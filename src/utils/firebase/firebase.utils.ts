...
const firebaseConfig = {
  ...
  export const addCollectionAndDocument = async <T extends ObjectToAdd>(collectionKey: string,
...
//   return categoryMap;
 ...
 export type UserData = {
  ...
  export const signInWithManualUserNameandPassword = async (email: string, password: string) => {
    if (!email || !password) return;
